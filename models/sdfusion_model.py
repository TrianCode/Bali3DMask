...
class SDFusionModel(BaseModel):
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        # Pastikan target berada di perangkat yang sama dengan model_output
        ...
        # Pastikan t berada di perangkat yang sama dengan self.logvar
        t = t.to(self.logvar.device)  # Pastikan t dipindahkan ke perangkat yang sama

        # Pastikan logvar_t diambil dari perangkat yang sesuai
        logvar_t = self.logvar[t].to(model_output.device)  # Pastikan logvar_t berada di perangkat yang sama

        # Pastikan semua tensor berada di perangkat yang sama
        loss_simple = loss_simple.to(logvar_t.device)
